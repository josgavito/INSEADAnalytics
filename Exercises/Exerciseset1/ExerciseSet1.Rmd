...
**Your Answers here:**
R package Task View https://cran.r-project.org/web/views/Finance.html
github repository https://github.com/Confunctionist/finance with integrated formulas like Black-Scholes model
...
The .R file used was dataSet1.R, the function myticketers is a matrix where SPY are the rows (day trade inforation) and the colum is the determined stock 
2.- 
I found two different codes for it

round(100*mean(StockReturns[,2]),1)
[1] 0.0007298525
...
3.- To check yahoo, first you have to define it on the function 
mytickers = c("SPY", "YHOO")   
YHOO = StockReturns[,"YHOO"]
pnl_plot(YHOO)
and do the same calculations with YHOO instead of StockReturns
<br>
<br>
<br>
...
**Your Answers here:**
<br>
startDate = "2001-01-01" you can change the date of start on the line of startDate in the dataSet1.R
<br>
<br>
<br>
...
**Your Answers here:**
<br>> It creates a matrix (1:20) as can be seen with the comands ncol, nrow. One can transpose to have 1 row 
